...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/shittycoin-project/shittycoin>";
    const std::string URL_WEBSITE = "<https://shittycoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("ShittyCoin version %s\n", FormatFullVersion());
}
