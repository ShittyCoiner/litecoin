...
{
    const char* pszTimestamp = "It was a bit windy today";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 10; // 3.5 days
        consensus.nPowTargetSpacing = 30;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 60; // 75% of 8064
        consensus.nMinerConfirmationWindow = 80; // nPowTargetTimespan / nPowTargetSpacing * 4
        ...
        genesis = CreateGenesisBlock(1516475000, 1923254, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0d8060744e2faaaeb1fab5e33ffdc6ab9f3f5e1383c8101f545ce521f2de4c2d"));
        assert(genesis.hashMerkleRoot == uint256S("0x5d1b8371cf645489b2c8c90304b2c92541280d3113c1c9ca409eedb5b625c43c"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("185.223.28.117", false);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1799431, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x603d318f0e5e69710f9df1e06033836eaff6035bb68fd8fff4a90d26c5125177"));
        assert(genesis.hashMerkleRoot == uint256S("0x5d1b8371cf645489b2c8c90304b2c92541280d3113c1c9ca409eedb5b625c43c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.shittycointools.com", true);
        vSeeds.emplace_back("seed-b.shittycoin.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf754c46f79fdcd92e8a8cf0a0eaf94b711e850852c0812afb32721056b0ef753"));
        assert(genesis.hashMerkleRoot == uint256S("0x5d1b8371cf645489b2c8c90304b2c92541280d3113c1c9ca409eedb5b625c43c"));
