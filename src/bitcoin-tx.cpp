...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shittycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shittycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shittycoin transaction") + "\n" +
              "  shittycoin-tx [options] -create [commands]   " + _("Create hex-encoded shittycoin transaction") + "\n" +
              "\n";
